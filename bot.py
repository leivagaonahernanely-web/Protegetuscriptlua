...
DOMINIO = os.getenv("DOMINIO", "https://vantaprotect-production.up.railway.app")
...
async def panel(interaction: discord.Interaction, api_key: str):
    ...
    try:
        ...
        with app.app_context():
            ...
            panel_title = user.panel_title if user.panel_title else "VantaProtect"
            panel_description = user.panel_description if user.panel_description else "Script protegido con VantaProtect"
...
async def stats(interaction: discord.Interaction):
    ...
    try:
        ...
        with app.app_context():
            ...
            embed.set_footer(text="VantaProtect - Sistema de protección")
...
async def on_ready():
    try:
        ...
        print(f"🛡️ VantaProtect - Sistema de protección activo")
    except Exception as e:
